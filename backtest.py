...
START_CASH       = 100_000
COMMISSION        = 0.001
STOP_LOSS_PCT     = 0.02    # default SL, overridable
TAKE_PROFIT_PCT   = 0.02    # default TP, overridable
...
class SignalStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.entry_price = {}
        self.entry_date  = {}
        self.trail_stop  = {}   # for true trailing stops on longs
    ...
    def next(self):
        for data in self.datas:
            ...
            # ─── Exit on reverse or neutral signal ─────────────────
            elif pos != 0:
...
def run_backtest(signals_df, stop_loss_pct, take_profit_pct, price_cache):
    ...
    winr  = (won/closed) if closed else None
    ...
    return {'sharpe': sharpe, 'cagr': cagr, 'max_dd': dd, 'trades': closed, 'win_rate': winr}
